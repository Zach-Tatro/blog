...
In a Pro Footbal Focus article "96 stats -- 3 fantasty football stats for every NFL team for 2019", Scott Barret compares Atlanta Falcons quarterback Matt Ryan's fantasy points when player indoors vs. outdoors. He says,
...
![boxplot](https://github.com/Zach-Tatro/blog/tree/master/images/posts/unnamed-chunk-3-1.png)
...
![qqplot](https://github.com/Zach-Tatro/blog/tree/master/images/posts/unnamed-chunk-4-1.png)
...
1.  **Equal variance.** We saw before in our boxplot that we may have an issue with unequal variance between our groups. As a general rule, if the ratio of standard deviations is less than 2 (larger sd in the numerator), you're probably safe to assume equal variance. The ratio here is 1.4. We could also used an F test to compare two variances and obtained an non-significant p-value.
...
<!-- -->
    ...
    ## 
    ## data:  Year.2018$Fant.Pts[Year.2018$Dome == "Indoors"] and Year.2018$Fant.Pts[Year.2018$Dome == "Outdoors"]
...
![histogram](https://github.com/Zach-Tatro/blog/tree/master/images/posts/unnamed-chunk-7-1.png)
